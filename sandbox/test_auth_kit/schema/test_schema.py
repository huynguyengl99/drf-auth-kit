...
from sandbox.test_utils.drf_spectacular import assert_schema, generate_schema
from test_utils.monkey_patch import temporary_class_attribute


def test_auth_kit_jwt_auth(no_warnings):
...
def test_auth_kit_token_auth(no_warnings):
...
def test_auth_kit_jwt_no_using_auth_cookie(no_warnings):
    import auth_kit.urls
